...
//
// FaceDetection service: detects faces in RGB frames
...
func (c *faceDetectionClient) DetectFaces(ctx context.Context, in *FrameRequest, opts ...grpc.CallOption) (*DetectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, FaceDetection_DetectFaces_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedFaceDetectionServer must be embedded to have
...
func (UnimplementedFaceDetectionServer) testEmbeddedByValue()                       {}
...
func RegisterFaceDetectionServer(s grpc.ServiceRegistrar, srv FaceDetectionServer) {
	// If the following call pancis, it indicates UnimplementedFaceDetectionServer was
